            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-2 bg-white shadow-md rounded-lg">
                    <div className="w-full grid grid-cols-1 md:grid-cols-6 gap-2 text-sm">
                        ...
                        <div className="font-bold md:col-span-5 p-2">{item?.USAGE_DAY_WEEK_AND_TIME}</div>
                        <div className="p-2 md:text-right">참가비</div>
                        <div className="font-bold md:col-span-5 p-2">{item?.USAGE_AMOUNT}</div>
                        ...
                        <div className="font-bold md:col-span-5 p-2">{item?.TRFC_INFO}</div>
