    ...
    <header className='bg-blue-600 text-white shadow-md'>
      <nav className='container h-15 mx-auto flex justify-between items-center'>
        ...
        <ul className='flex space-x-4'>
          <li>
            <Link href="/" className='hover:font-bold hover:bg-blue-50 p-2 border rounded-sm hover:text-blue-900'>
              홈
            </Link>
          </li>
          {isLogin && <>
          <li>
            <Link href="/lotto" className='hover:font-bold hover:bg-blue-50 p-2 border rounded-sm hover:text-blue-900'>
              로또
            </Link>
          </li>
          <li>
            <Link href="/festival" className='hover:font-bold hover:bg-blue-50 p-2 border rounded-sm hover:text-blue-900'>
              축제
            </Link>
          </li>
          <li>
